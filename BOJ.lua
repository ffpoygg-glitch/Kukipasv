			...
			if message.TextSource then
				...
				while true do
					if (FlatIdent_1BC4A == 0) then
						senderPlayer = Players:GetPlayerByUserId(message.TextSource.UserId);
